...
{
       0,    52,    52,    56,    57,    60,    64,    74,    75,    79,
      80,    84,    91,    92,    96,   104,   112,   113,   117,   125,
     129,   138,   146,   155,   168,   171
};
#endif
...
static const char *const yytname[] =
{
  ...
  "PIPE", "AMP", "GREATGREAT", "GREATAMP", "GREATGREATAMP", "TWOGREAT",
  "NEWLINE", "$accept", "goal", "commands", "command", "simple_command",
  "pipe_list", "command_and_args", "argument_list", "argument",
  "command_word", "iomodifier_list", "iomodifier_opt", "background_opt", YY_NULLPTR
};
#endif
...
{
       1,    -8,    -9,    -9,     6,     0,    -9,    -9,     2,    -9,
      -9,    -9,    -9,    -9,     4,    10,     5,    -9,     7,     8,
      -9,     9,    14,    20,    21,    -9,    12,    -9,    -9,    -9,
      -9,    -9,    -9,    -9,    -9,    -9
};
...
{
      -2,     1,     1,     2,     2,    11,    12,     2,    27,    14,
      29,    30,    31,     3,     3,    18,    19,    32,    20,    21,
      22,    23,    24,    33,    34,    35,     0,    13,     0,    17
};

static const yytype_int8 yycheck[] =
{
       0,     1,     1,     3,     3,    13,     0,     3,     3,     7,
       3,     3,     3,    13,    13,     5,     6,     3,     8,     9,
      10,    11,    12,     3,     3,    13,    -1,     5,    -1,    14
};
...
static const yytype_int8 yystos[] =
{
      ...
      23,    13,     0,    17,     7,    24,    21,    20,     5,     6,
       8,     9,    10,    11,    12,    25,    26,     3,    22,     3,
       3,     3,     3,     3,     3,    13
};
